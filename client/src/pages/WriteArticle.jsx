...
import { Edit, MonitorSmartphoneIcon, PencilRuler, Copy } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 p-4 md:p-6 lg:p-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-start">
          ...
          {/* Right: Output */}
          <div className="bg-white rounded-xl md:rounded-2xl shadow-lg border border-blue-100 p-5 md:p-8 min-h-96 md:min-h-80 max-h-96 md:max-h-[600px] flex flex-col backdrop-blur-sm order-2 lg:order-none">
            <div className="flex items-center justify-between mb-4 md:mb-6">
              <div className="flex items-center gap-2 md:gap-3 min-w-0">
                <div className="p-2 bg-blue-100 rounded-lg flex-shrink-0">
                  <Edit className="w-4 h-4 md:w-5 md:h-5 text-blue-600" />
                </div>
                <h2 className="text-lg md:text-2xl font-bold text-gray-900 truncate">Generated Response</h2>
              </div>
              {content && (
                <button
                  onClick={handleCopy}
                  className="p-2 hover:bg-blue-50 rounded-lg transition-colors duration-200 text-gray-600 hover:text-blue-600 flex-shrink-0"
              ...
              <div className="flex-1 flex justify-center items-center">
                <div className="text-center px-4">
                  ...
                  <p className="text-gray-600 font-medium text-sm md:text-base leading-relaxed">
                    Enter a topic and click<br className="md:hidden" /> "Generate Article" to start
                  </p>
                </div>
              </div>
            ) : (
              <div className="mt-2 h-full overflow-y-auto text-gray-700 leading-relaxed text-sm md:text-base">
                <div className="prose prose-sm md:prose-base max-w-none prose-headings:text-blue-900 prose-a:text-blue-600 prose-strong:text-blue-900">
                  <Markdown
                    components={{
                      h1: ({node, ...props}) => <h1 className="text-xl md:text-2xl font-bold text-blue-900 mt-4 md:mt-6 mb-3 md:mb-4" {...props} />,
                      h2: ({node, ...props}) => <h2 className="text-lg md:text-xl font-bold text-blue-800 mt-3 md:mt-5 mb-2 md:mb-3" {...props} />,
                      h3: ({node, ...props}) => <h3 className="text-base md:text-lg font-bold text-blue-700 mt-3 md:mt-4 mb-2" {...props} />,
                      p: ({node, ...props}) => <p className="text-gray-700 mb-3 md:mb-4 leading-relaxed" {...props} />,
                      ul: ({node, ...props}) => <ul className="list-disc list-inside mb-3 md:mb-4 space-y-1.5 md:space-y-2" {...props} />,
                      ol: ({node, ...props}) => <ol className="list-decimal list-inside mb-3 md:mb-4 space-y-1.5 md:space-y-2" {...props} />,
