const Testimonial = () => {
  ...
  return (
    <>
      ...
      {/* Big centered title */}
     <h2 className="text-slate-800 text-6xl sm:text-6x2 font-extrabold text-center mb-10">
 Trusted by Creators 
</h2>
<p className='text-gray-500 text-center max-w-lg mx-auto'>Hear directly from the people who rely on our tools daily, sharing their experiences, insights, and the meaningful impact our platform brings to their workflow.</p>
